...
function [Conflict,conflict_withtasks] = Conflict_degree1(i,j,SE_sats,W,tasks_num,duration)
        ...
        if q == i || isempty(SE_sats.TW_tasks{q,j})
            ...
            for x = 1:k
                ...
                if tw(2)-tw(1)+tw_obj(2)-tw_obj(1)-(max([tw(2),tw_obj(2)])-...
                    ...
                    conflict_withtasks(q,p) = prob*W(q)/k; % 在conflict_tasks上填充冲突任务
                    %  冲突度累加
